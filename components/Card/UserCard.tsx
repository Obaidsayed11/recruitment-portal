...
const UserCard = forwardRef<HTMLDivElement, UserCardProps>(
  ({ data, isSelected, onCardSelect, onDelete, onUpdate }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`bg-background p-2 group w-max xl:w-full my-1 border-t border-t-[#F5F5F5] border-b border-b-[#F5F5F5] grid text-nowrap grid-cols-[20px_250px_150px_150px_250px_150px] md:grid-cols-[20px_190px_130px_130px_200px_110px] xl:grid-cols-[20px_1.5fr_1.1fr_1fr_2fr_1fr] gap-5  transition-all ease-linear border items-center ${
          isSelected
