...
<div className="border bg-white rounded-lg p-4 mb-6 flex flex-col lg:flex-row items-center lg:items-stretch gap-4">
  ...
  <div className="flex flex-col lg:flex-row items-center w-full lg:w-1/2 gap-6">
    {/* --- Logo & Name --- */}
    ...
    <div className="flex flex-col gap-1 mt-2 text-center lg:text-left">
      ...
      {company.careerPageUrl && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-sm text-blue-600 hover:underline flex items-center gap-1 justify-center lg:justify-start"
        >
          {company.careerPageUrl}
          <ExternalLink className="w-3 h-3" />
        </a>
