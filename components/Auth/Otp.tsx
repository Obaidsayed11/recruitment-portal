...
function Otp() {
  ...
  const onSubmit: SubmitHandler<OtpData> = async (data) => {
    ...
    // ✅ Redirect to reset-password with correct params
    const query = new URLSearchParams({ otp: otpValue });
  ...
  return (
    <div className="flex flex-col bg-white p-4 rounded-3xl relative w-full gap-5 items-center sm:p-10">
      <div className="grid justify-center gap-2">
        ...
        <h1 className="text-center text-xl font-medium leading-5 text-text">
          Enter OTP
        </h1>
      </div>
